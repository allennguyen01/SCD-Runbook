...
for obj in Objects:
    ...
    if  typeid == 'Reference' or typeid == 'JobPlan' or typeid == 'Plan':
        ...
        enabled = obj.find('Enabled').text
        pidDict.update({ID: [name, PID, typeid, enabled]})
